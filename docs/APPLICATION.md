...
`trinetra/application` exports `createApplication`. Importing it does not
...
```js
import { createApplication } from 'trinetra/application';
import { createApplicationViewer } from 'trinetra/application/viewer';
