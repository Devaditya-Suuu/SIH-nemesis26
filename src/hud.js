 ...
 * (GSD, NIIRS), timestamps, and orbital data — all updating in
...
export class IntelHUD {
  ...
  /**
   * Start all periodic update timers. Timers run independently at different
  ...
  * altitude, view window dimensions, sun elevation, and local timezone.
  ...
  _composeSummary() {
    ...
    return `${modeLabel} ${band} ${localityTag} | ${region} | ALT ${altTag} | WINDOW ${winTag} | SUN ${m.sunEl.toFixed(0)}° | ${localTag}`;
  }
